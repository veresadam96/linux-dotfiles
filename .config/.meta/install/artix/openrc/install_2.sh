...
packages() {
	...
	#utilities
	packages+=("sudo" "ripgrep" "fd" "zip" "unzip" "unrar" "fzf" "bat" "fastfetch" "fuse" "atool" "tmux" "usbutils" "jq" "cronie" "ntp" "htop" "libinput" "libinput-tools" "fwupd" "innoextract" "binwalk" "cloud-guest-utils");
	#CD/DVD
...
#special kernel param for new lenovo ideapad: pcie_port_pm=off pcie_aspm=off
grub() {
