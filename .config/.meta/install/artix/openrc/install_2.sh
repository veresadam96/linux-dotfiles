...
packages() {
	...
	#utilities
	packages+=("sudo" "ripgrep" "fd" "zip" "unzip" "unrar" "fzf" "bat" "fastfetch" "fuse" "atool" "tmux" "usbutils" "jq" "cronie" "ntp" "htop" "libinput" "libinput-tools" "fwupd" "innoextract" "binwalk");
	#CD/DVD
